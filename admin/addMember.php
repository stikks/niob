        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="javascript:void(0)">
                                        <img src="../img/avatar.png" class="thumb-lg img-circle" alt="img">
                                    </a>
                ...
                <div class="col-md-10 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" action="createMember.php" role="form" method="post"
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="status" id="status" value="non_registered"
                                                   checked> Non Registered Member
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select name="membership_cadre" id="cadre"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="member_registration_number"
                                               id="member_registration_number" placeholder="MNIOB Registration Number" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-2 mb-sm-0">
                                            ...
                                            <input type="text" name="corbon_number" id="corbon_number"
                                                   placeholder="&nbsp;Corbon Number" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="col-md-6 input-group date">
                                        <label for="niob_admission_date">NIOB Admission Date</label>
                                        <input type="text" class="form-control" name="niob_admission_date"
                                               placeholder="Select NIOB Admission Date"
                                               id="niob_admission_date">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label>Surname</label>
                                        <input type="text" placeholder="Surname" name="surname" class="form-control form-control-line" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Other Names</label>
                                        <input type="text" name="other_names" placeholder="Other Names" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label for="email">Email</label>
                                        <input type="email" placeholder="Email Address" class="form-control form-control-line" name="email" id="email" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Phone Number</label>
                                        <input type="text" name="phone" placeholder="Phone Number" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group" style="padding: 20px;">
                                    <div class="col-md-12 input-group date">
                                        ...
                                        <input type="text" class="form-control" name="dob"
                                               placeholder="Select date of birth" id="dob" data-date-format="yy-mm-dd">
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="address" id="address" rows="3" class="form-control form-control-line">
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control form-control-line" name="highest_acad_qual"
                                                id="highest_acad_qual" required>
                                            <option value="">Select Highest Qualification</option>
                                            <option value='Phd'>Phd
                                            </option>
                                            <option value='Msc'>Msc
                                            </option>
                                            <option value='PGD'>PGD
                                            </option>
                                            <option value='Bachelors'>Bsc/B.Tech
                                            </option>
                                            <option value='HND'>HND
                                            </option>
                                            <option value='OND'>OND
                                            </option>
                                            <option value='NCE'>NCE
                                            </option>
                                            <option value='WASSCE'>WASSCE
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 input-group date" data-provide="year">
                                        <label for="year_education">Qualification Year</label>
                                        <input type="text" class="form-control year" name="year_education" placeholder="select qualification year" id="year_education" required>
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control form-control-line" name="school" id="school"
                                               type="text" placeholder="Enter Academic Institution" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" placeholder="Current Employer" name="current_employer" class="form-control form-control-line" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Position Held</label>
                                        <input type="text" name="position_held" placeholder="Position Held" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="additional_info">Additional Information</label>
                                        <textarea name="additional_info" id="additional_info" rows="3" class="form-control form-control-line"></textarea>
                                    </div>
                                </div>
                            </div>
